...
public class EmployeeView {
    ...
    public static void run(){
        while (state){
            ...
            System.out.println("4. 사원정보 수정하기.");
    ...
    {
        Scanner sc = new Scanner(System.in);
        System.out.println("조회할 사원의 이름을 입력해주세요. : ");
    ...
    public static void empInsert()
    {
        ...
        System.out.println("등록할 사원의 정보를 입력하세요 - > ");
        ...
        System.out.println("월급레벨 (S1 - S6) -> " );
        emp.setSalLelvel(sc.nextLine());
    ...
    {
        Scanner sc = new Scanner(System.in);
        System.out.println("변경할놈 번호 입력 =>");
        String index = sc.nextLine();

        EmployeeDTO emp = employeeService.employeeFindById(index);

        if(emp == null)
        {
            System.out.println("변경할 대상이 업습니다.");
            return;
        }
        System.out.println(emp);
