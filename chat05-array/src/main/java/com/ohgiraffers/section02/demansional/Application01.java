...
public class Application01
{
    public static void main(String[] args)
    {
        ...
        더 많은 차원의 배열은 사용할 수 있지만 일반적으로 2차원 배열보다 더 높은 차원의 사용 배열은 사용빈도가 적다.
         */
/*
2차원 배열을 사용하는 방법.
1. 배열의 주소를 보관할 레퍼런스 변수를 선언.(stack
2. 여러 개의 1ㅏ원 배열의 주소를 관리하는 배열을 생성.(heap)
3. 각 인덱스에서 관리하는 배열을 할당 하여 주소를 보관하는 배열에 저장
4. 생성한 여러 개의 1차원 배열을 차례로 접근하여 사용
표현식
